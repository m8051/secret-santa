...
class FacebookApplication implements ApplicationInterface
{
    const SESSION_KEY_STATE = 'santa.facebook.state';

    private const SESSION_KEY_TOKEN = 'santa.facebook.token';
    private const SESSION_KEY_ADMIN = 'santa.facebook.admin';
